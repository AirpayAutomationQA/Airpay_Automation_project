...
public class TC_PP_UPIAddress_Empty_Transaction_ErrorMessage_NewDesign extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_Payment_Mode_CreditCard_BusinessLogic CreditCard = new AirPay_Payment_Mode_CreditCard_BusinessLogic(driver, TC_ID);				
				...
				CreditCard.Popular_UPI_Wallet_VerificationErrMsg();
				//CreditCard.UPIErrorMSgForALL();
