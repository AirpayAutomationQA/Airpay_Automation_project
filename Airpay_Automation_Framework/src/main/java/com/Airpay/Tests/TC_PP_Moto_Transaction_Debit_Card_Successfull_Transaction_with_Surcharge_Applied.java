...
public class TC_PP_Moto_Transaction_Debit_Card_Successfull_Transaction_with_Surcharge_Applied extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			DebitCard.Debit_SurchargeValuesWithValidCardNumber();
