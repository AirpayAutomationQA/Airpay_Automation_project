...
public class TC_PP_NetBanking_Previous_Selected_PopularBank_Inline_kit extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_PaymentPage_BusinessLogic AirPay_Local = new AirPay_PaymentPage_BusinessLogic(driver, TC_ID);
				...
				AirPay_Local.Popular_bank_verification_previous_selectedBank();
