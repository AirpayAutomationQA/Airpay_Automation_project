...
public class TC_ID_020_Verify_can_user_create_new_rules_on_Global_level_which_is_same_as_merchant_level extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			MA_panel.RuleAddDetails();
			MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.SurchargeSubmitBtn);
			MA_panel.DuplicateRuleNameErrorExist("Sorry!!, the rule title already exist.");												
