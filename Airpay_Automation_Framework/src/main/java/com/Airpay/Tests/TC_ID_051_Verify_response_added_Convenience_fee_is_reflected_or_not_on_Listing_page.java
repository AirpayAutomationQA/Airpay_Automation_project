...
public class TC_ID_051_Verify_response_added_Convenience_fee_is_reflected_or_not_on_Listing_page extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
		   ...
		   //	MA_panel.Verify_Button_Color(AirPay_Payment_MA_Panel_PageObject.MM_CheckbxColor);
