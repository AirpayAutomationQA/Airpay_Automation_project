...
public class TC_PP_EMI_Card_logo_Appearance_Inline_kit extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_Local.NavigateToInlineKit();	
				...
				CreditCard.Credit_LogoValidations(Airpay_PaymentPage_PageObject.EMICardNumber);			
