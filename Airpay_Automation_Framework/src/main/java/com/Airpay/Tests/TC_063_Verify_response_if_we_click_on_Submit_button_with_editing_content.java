...
public class TC_063_Verify_response_if_we_click_on_Submit_button_with_editing_content extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			MA_panel.RuleCreatedVerify();
			MA_panel.RuleCreatedEditMode();
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.EditGlobalSurchagrePage, "Edit global surcharge rule");
			MA_panel.EditConvienceSurchargeRuleVerifyPage();
			MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.SurchargeSubmitBtn);
			MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.RuleEditPopErrorMsg);
			MA_panel.DuplicateRuleNameErrorExist("Rule updated successfully");				
