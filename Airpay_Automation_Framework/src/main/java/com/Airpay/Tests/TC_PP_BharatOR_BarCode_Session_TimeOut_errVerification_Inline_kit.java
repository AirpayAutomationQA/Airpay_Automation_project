...
public class TC_PP_BharatOR_BarCode_Session_TimeOut_errVerification_Inline_kit extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_Payment_Mode_EMI_Credit_Card_BusinessLogic EMI = new AirPay_Payment_Mode_EMI_Credit_Card_BusinessLogic(driver, TC_ID);
				...
				EMI.BharatQRMakePayBtn();
				EMI.Verify_BharatQR_BarCodeImg();							
				//EMI.EMI_Invalid_card_Details();
				EMI.sessionTimeOut_errMsg();
