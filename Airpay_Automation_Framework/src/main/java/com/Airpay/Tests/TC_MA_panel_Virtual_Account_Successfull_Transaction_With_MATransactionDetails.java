...
public class TC_MA_panel_Virtual_Account_Successfull_Transaction_With_MATransactionDetails extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			EMI.VirtualAccountDetails();
			EMI.VirtualBankMakePaymentBtnClick();
