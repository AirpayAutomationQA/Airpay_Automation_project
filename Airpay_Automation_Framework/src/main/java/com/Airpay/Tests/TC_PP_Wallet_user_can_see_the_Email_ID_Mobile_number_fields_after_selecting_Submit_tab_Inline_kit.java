...
public class TC_PP_Wallet_user_can_see_the_Email_ID_Mobile_number_fields_after_selecting_Submit_tab_Inline_kit extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_payment_Mode_Wallet_BusinessLogic Wallet = new AirPay_payment_Mode_Wallet_BusinessLogic(driver, TC_ID);	
				...
				Wallet.WalletDropDown_Selecting_Email_and_MobileVerifying();				
