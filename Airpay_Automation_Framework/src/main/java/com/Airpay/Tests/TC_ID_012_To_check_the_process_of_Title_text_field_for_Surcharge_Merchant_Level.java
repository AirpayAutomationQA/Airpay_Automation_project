...
public class TC_ID_012_To_check_the_process_of_Title_text_field_for_Surcharge_Merchant_Level extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			Thread.sleep(1000);
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.TitleErrMsg, "Please enter Rule Title");
			//	MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.TitleErrMsg, "Please enter valid Rule Title");
			//MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.MccErrorMsg, "Please select MCC");
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.ChannelErrMsg, "Please select Channel");
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.AmonutErrMsg, "Please enter Amount");			
			MA_panel.InputValue(AirPay_Payment_MA_Panel_PageObject.TitleInput, ")394hdhdd+_)");
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.TitleErrMsg, "Please enter valid Rule Title");			
			MA_panel.InputValue(AirPay_Payment_MA_Panel_PageObject.AmountInput, "jdjdk");
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.AmonutErrMsg, "Please enter valid Amount");
			MA_panel.InputValue(AirPay_Payment_MA_Panel_PageObject.AmountInput, "-12");
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.AmonutErrMsg, "Please enter a value greater than or equal to 0.");
