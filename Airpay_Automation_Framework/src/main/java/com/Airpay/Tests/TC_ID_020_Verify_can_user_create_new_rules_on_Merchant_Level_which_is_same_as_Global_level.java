...
public class TC_ID_020_Verify_can_user_create_new_rules_on_Merchant_Level_which_is_same_as_Global_level extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.MerchantAssignSurchargeRule);				
			...
			MA_panel.DuplicateMerchantRuleAdd();
			MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.SurchargeSubmitBtn);
			MA_panel.DuplicateRuleNameErrorExist("Rule title already exist");												
