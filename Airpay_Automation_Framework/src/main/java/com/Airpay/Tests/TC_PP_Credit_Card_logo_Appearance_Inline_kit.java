...
public class TC_PP_Credit_Card_logo_Appearance_Inline_kit extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_Payment_Mode_CreditCard_BusinessLogic CreditCard = new AirPay_Payment_Mode_CreditCard_BusinessLogic(driver, TC_ID);
				...
				CreditCard.Credit_LogoValidations(Airpay_PaymentPage_PageObject.CreditCardNoInput);			
