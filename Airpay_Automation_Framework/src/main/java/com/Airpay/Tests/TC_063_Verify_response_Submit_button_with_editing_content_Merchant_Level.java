...
public class TC_063_Verify_response_Submit_button_with_editing_content_Merchant_Level extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			MA_panel.MerchantRuleCreatedVerify();
			//MA_panel.RuleCreatedEditMode();
			MA_panel.VerifyText(AirPay_Payment_MA_Panel_PageObject.EditMerchantSurchagrePage, "edit merchant surcharge rule");
			MA_panel.EditSurchargeRuleVerifyPage();
			MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.SurchargeSubmitBtn);
