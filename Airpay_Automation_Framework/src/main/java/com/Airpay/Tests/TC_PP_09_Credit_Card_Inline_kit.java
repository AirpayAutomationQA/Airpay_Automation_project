...
public class TC_PP_09_Credit_Card_Inline_kit extends Driver_Setup{
	...
	public void TC_TestCaseName() throws Throwable {
		try {
			...
			AirPay_Payment_Mode_CreditCard_BusinessLogic CreditCard = new AirPay_Payment_Mode_CreditCard_BusinessLogic(driver, TC_ID);
				...
				CreditCard.Credit_cardValidation();	
				CreditCard.CaseSensitiveValidation(Airpay_PaymentPage_PageObject.CreditCardNoInput,"[^'a-zA-Z ]");	
				CreditCard.Credit_CardCVVRedError(Airpay_PaymentPage_PageObject.CreditCardCVVCode,Airpay_PaymentPage_PageObject.CreditCardMakePaymtBtn);
				CreditCard.Credit_CardExpiryDateErrorRedLine(Airpay_PaymentPage_PageObject.CreditCardExpDate,Airpay_PaymentPage_PageObject.CreditCardMakePaymtBtn);				
